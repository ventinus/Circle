...
export default class CircleView {
    ...
    updateStyles(speed) {
        this.$circleMain.css({
            '-webkit-transform': 'rotate(' + this.rotateAmount + 'deg)',
            '-moz-transform': 'rotate(' + this.rotateAmount + 'deg)',
            '-ms-transform': 'rotate(' + this.rotateAmount + 'deg)',
            '-o-transform': 'rotate(' + this.rotateAmount + 'deg)',
            'transform': 'rotate(' + this.rotateAmount + 'deg)',
            '-webkit-transition': 'transform ' + TIMING_FN + ' ' + speed + 'ms',
            '-moz-transition': 'transform ' + TIMING_FN + ' ' + speed + 'ms',
            '-ms-transition': 'transform ' + TIMING_FN + ' ' + speed + 'ms',
            '-o-transition': 'transform ' + TIMING_FN + ' ' + speed + 'ms',
            'transition': 'transform ' + TIMING_FN + ' ' + speed + 'ms'
        });
        this.$circleItems.eq(0).css({
            '-webkit-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-moz-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-ms-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-o-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            'transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-webkit-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-moz-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-ms-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-o-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            'transition': 'all ' + TIMING_FN + ' ' + speed + 'ms'
        });
        this.$circleItems.eq(2).css({
            '-webkit-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-moz-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-ms-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
            '-o-transform': 'translate(-50%, 0) rotate(' + -this.rotateAmount + 'deg)',
        ...
        this.$circleItems.eq(1).css({
            '-webkit-transform': 'translate(0, -50%) rotate(' + -this.rotateAmount + 'deg)',
            '-moz-transform': 'translate(0, -50%) rotate(' + -this.rotateAmount + 'deg)',
            '-ms-transform': 'translate(0, -50%) rotate(' + -this.rotateAmount + 'deg)',
            '-o-transform': 'translate(0, -50%) rotate(' + -this.rotateAmount + 'deg)',
            'transform': 'translate(0, -50%) rotate(' + -this.rotateAmount + 'deg)',
            '-webkit-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-moz-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-ms-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
            '-o-transition': 'all ' + TIMING_FN + ' ' + speed + 'ms',
